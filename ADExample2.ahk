...
getLocalUser(usr=""){
	...
	dllCall("MultiByteToWideChar","uint",0, "uint",0,"str",usr, "uint",-1, "uint",&sUserW, "uint",L+1)
	...
	dllCall("WideCharToMultiByte","uint",0, "uint",0, "uint",pUFN, "int",-1, "str",sRet, "uint",L, "uint",0, "uint",0)
	return sRet
}